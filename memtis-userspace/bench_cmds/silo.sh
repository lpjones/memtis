...
BIN=/proj/TppPlus/tpp/memtis/memtis-userspace/bench_dir/silo/out-perf.masstree/benchmarks
...
BENCH_RUN="${BIN}/dbtest --verbose --bench ycsb --num-threads 16 --scale-factor 130000 --runtime 300 --slow-exit"
BENCH_DRAM="max"
